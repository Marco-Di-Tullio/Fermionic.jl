...
@testset "Fermionic.jl" begin
    ...
    @test rhomd(State_fixed(fixed_state(1/sqrt(2)*(ad(Op(6),1)*ad(Op(6),2)*ad(Op(6),3)*ad(Op(6),4)+ad(Op(6),3)*ad(Op(6),4)*ad(Op(6),5)*ad(Op(6),6))*vacuum(Op(6)),4),Op_fixed(6,4)),Op(6),2)[6,6] == 0.5
    @test rhomd(State_fixed(fixed_state(1/sqrt(2)*(im*ad(Op(6),1)*ad(Op(6),2)*ad(Op(6),3)*ad(Op(6),4)+ad(Op(6),3)*ad(Op(6),4)*ad(Op(6),5)*ad(Op(6),6))*vacuum(Op(6)),4),Op_fixed(6,4)),Op(6),2)[1,1] == 1.0
    @test rhom(State_fixed(fixed_state(1/sqrt(2)*(im*ad(Op(6),1)*ad(Op(6),2)*ad(Op(6),3)*ad(Op(6),4)+ad(Op(6),3)*ad(Op(6),4)*ad(Op(6),5)*ad(Op(6),6))*vacuum(Op(6)),4),Op_fixed(6,4)),Op(6),2)[1,15] == -0.5im
